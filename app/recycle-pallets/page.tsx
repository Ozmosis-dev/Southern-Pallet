...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Used Pallet Recycling & Buyback",
    description: "Sell surplus wood pallets or schedule recycling and pickup with Southern Pallet across Alabama, Mississippi, and the Southeast.",
    url: "/recycle-pallets",
  ...
  "@graph": [
    {
      ...
      offers: {
        ...
        url: `${SITE_URL}/recycle-pallets#quote`,
      },
    },
    {
      "@type": "BreadcrumbList",
